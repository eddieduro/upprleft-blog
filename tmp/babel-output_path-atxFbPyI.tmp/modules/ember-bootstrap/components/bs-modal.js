...
export default Ember.Component.extend({
  ...
  show: function show() {
    ...
    var callback = function callback() {
      ...
      if (this.get('usesTransition')) {
        this.get('modalElement').one('bsTransitionEnd', Ember.run.bind(this, function () {
          this.takeFocus();
  ...
  hide: function hide() {
    ...
    if (this.get('usesTransition')) {
      this.get('modalElement').one('bsTransitionEnd', Ember.run.bind(this, this.hideModal)).emulateTransitionEnd(Modal.TRANSITION_DURATION);
    } else {
      this.hideModal();
    }
  },
  ...
  handleBackdrop: function handleBackdrop(callback) {
    ...
    if (this.get('open') && this.get('backdrop')) {
      ...
      var waitForFade = function waitForFade() {
        ...
        if (doAnimate) {
          $backdrop.one('bsTransitionEnd', Ember.run.bind(this, callback)).emulateTransitionEnd(Modal.BACKDROP_TRANSITION_DURATION);
        } else {
          callback.call(this);
        }
      };
      ...
      if (doAnimate) {
        $backdrop.one('bsTransitionEnd', Ember.run.bind(this, callbackRemove)).emulateTransitionEnd(Modal.BACKDROP_TRANSITION_DURATION);
      } else {
